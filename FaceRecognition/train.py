...
print("ArcFace expects ", model.input_shape[1:], " inputs")
print("and it represents faces as ", model.output_shape[1:], " dimensional vectors")
...
labels = tf.keras.utils.to_categorical(labels, num_classes=class_number)
